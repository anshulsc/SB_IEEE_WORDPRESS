...
<div class="wrapper-area">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'avadanta-invest' ); ?></a>
		<?php 
	...
	if($avadanta_top_header_enable==1) {
			...
			<div class="container">
				<div class="topbar-left-content ">
					<div class="topbar-socials">
						...
						$avadanta_header_youtube_social_url = get_theme_mod('avadanta_header_youtube_social_url','');
						 ?>
						...
						<?php }  if($avadanta_header_insta_social_url!=='') { ?>
							...
							<?php }  if($avadanta_header_youtube_social_url!=='') {?>
							<li><a target="_blank" href="<?php echo esc_url($avadanta_header_youtube_social_url); ?>"><i class="fa fa-youtube"></i></a></li>
							<?php } ?>
						</ul>
					</div>
				</div>
		...
		<?php } ?>
	<div class="header-box <?php if($avadanta_top_header_enable==0) { ?>header-invest <?php } ?>">
						...
						{ ?>
								<ul class="add-child-header">
                                    <li class="header-menus">
                                        <a href="<?php echo esc_url( admin_url( 'nav-menus.php' ));  ?>"><?php echo esc_html__( 'Add Main Menu', 'avadanta-invest' ); ?>
                                        </a>
                                    </li>
                                </ul>
						<?php
