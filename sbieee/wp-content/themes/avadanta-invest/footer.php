			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
                    <div class="agency-copyright text-center my-20">
                            ...
                            <?php else : ?>
                            <?php
                            printf( __( 'Proudly powered by', 'avadanta-invest' ) );
                            ?>
                            <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'avadanta-invest' ) ); ?>" class="imprint">
                            	
							<?php
                            printf( __( 'WordPress', 'avadanta-invest' ) );
                            ?>
                            </a>
