...
function jupiterx_add_template_help_link() {
	if ( jupiterx_is_help_links() ) {
		echo wp_kses( '<a class="jupiterx-template-help-link" target="_blank" href="' . esc_url( 'https://themes.artbees.net/docs/setting-page-template/' ) . '">' . esc_html__( 'Help', 'jupiterx-lite' ) . '</a>', [
			'a' => [
				'class' => [],
				'target' => [],
				'href' => [],
