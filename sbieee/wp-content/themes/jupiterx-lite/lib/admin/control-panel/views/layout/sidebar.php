		...
		<li class="jupiterx-cp-sidebar-list-items <?php echo esc_attr( $extra_classes ); ?>">
			<a class="jupiterx-cp-sidebar-link" href="#<?php echo esc_attr( $section['href'] ); ?>">
				...
				<?php if ( 'home' === $key && ! jupiterx_is_registered() && jupiterx_is_premium() ): ?>
					<img class="jupiterx-premium-warning-badge" src="<?php echo esc_url( JUPITERX_ADMIN_URL . 'control-panel/assets/images/warning-badge.svg' ); ?>" title="<?php _e( 'Activate Product', 'jupiterx-lite' ); ?>" alt="<?php esc_attr_e( 'Warning icon', 'jupiterx-lite' ); ?>" width="16" height="16"/>
				<?php endif; ?>
				<?php if ( 'system_status' === $key && count( $sysinfo_warnings ) > 0 ): ?>
					<img class="jupiterx-premium-warning-badge" src="<?php echo esc_url( JUPITERX_ADMIN_URL . 'control-panel/assets/images/warning-badge.svg' ); ?>" title="<?php _e( 'Resolve issues', 'jupiterx-lite' ); ?>" alt="<?php esc_attr_e( 'Warning icon', 'jupiterx-lite' ); ?>" width="16" height="16"/>
				<?php endif; ?>
				<?php if ( 'updates' === $key && $new_update_available ): ?>
					<img class="jupiterx-premium-warning-badge" src="<?php echo esc_url( JUPITERX_ADMIN_URL . 'control-panel/assets/images/warning-badge.svg' ); ?>" title="<?php _e( 'Update Available', 'jupiterx-lite' ); ?>" alt="<?php esc_attr_e( 'Warning icon', 'jupiterx-lite' ); ?>" width="16" height="16"/>
				<?php endif; ?>
			</a>
		</li>
	<?php endforeach; ?>
