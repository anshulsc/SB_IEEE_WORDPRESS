<?php
/**
 * PixelPop\Sidebars\Component class
 *
 * @package pixelpop
 */

namespace PixelPop\Sidebars;
 ...
 * * `pixelpop()->is_primary_sidebar_active()`
 * * `pixelpop()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Sidebar', 'pixelpop' ),
				'id'            => static::PRIMARY_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Add widgets here.', 'pixelpop' ),
				'before_widget' => '<section id="%1$s" class="ppop-widget ppop-layout-box %2$s">',
				'after_widget'  => '</section>',
				'before_title'  => '<h3 class="ppop-widget-title widget-title">',
				'after_title'   => '</h3>',
			)
		);
	}
