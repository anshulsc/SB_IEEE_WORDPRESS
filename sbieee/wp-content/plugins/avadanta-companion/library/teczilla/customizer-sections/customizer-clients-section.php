<?php
if ( ! function_exists( 'avata_teczilla_clients_customize_register' ) ) :
function avata_teczilla_clients_customize_register($wp_customize){
...
add_action( 'customize_register', 'avata_teczilla_clients_customize_register' );
endif;
    /**
...
function avata_avadanta_register_home_clients_section_partials( $wp_customize ){
	...
	$wp_customize->selective_refresh->add_partial( 'avadanta_clients_content', array(
		'selector'            => '.tec-partner .tec-carousel-2',
