...
function avata_avadanta_get_slider_default() {
	...
	return apply_filters(
		'avadanta_slider_content', json_encode(
			array(
				array(
				'title'      => esc_html__( 'Simple & Intuitive Solution

', 'teczilla' ),
				'text'       => esc_html__('we offer a theme tailored for high performace in desing speed and marketing and value of technology.



', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider-creative.jpg'),
				),
				array(
				'title'      => esc_html__( 'Solution & Integration
...
', 'teczilla'),
				'link'      => '#',
                'image_url'     => esc_url(AVATA_PLUGIN_URL . 'library/teczilla/assets/images/slider-dark.jpg'),
				),
